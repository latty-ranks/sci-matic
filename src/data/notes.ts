...
export const topicNotes: TopicNote[] = [
...

  {
    topicId: "p1-1",
    sections: [
      { heading: "SI Units", content: "Length: metre (m). Mass: kilogram (kg). Time: second (s). Temperature: kelvin (K). Current: ampere (A). Amount of substance: mole (mol)." },
      { heading: "Measuring Instruments", content: "Metre rule (±0.5 mm). Vernier calipers (±0.01 cm): read main scale + vernier scale. Micrometer screw gauge (±0.01 mm): read main scale + thimble scale." },
      { heading: "Density", content: "Density = mass/volume. Unit: kg/m³ or g/cm³. To find volume of irregular objects, use water displacement method." },
    ],
    examples: [
      { problem: "A metal block has mass 500 g and volume 200 cm³. Find its density.", solution: "ρ = m/V = 500/200 = 2.5 g/cm³." },
    ],
  },
  {
    topicId: "p1-2",
    sections: [
      { heading: "Particle Model", content: "Solids: particles tightly packed, vibrate in fixed positions. Liquids: particles close but can slide past each other. Gases: particles far apart, move freely at high speed." },
      { heading: "Changes of State", content: "Melting: solid → liquid. Boiling/evaporation: liquid → gas. Condensation: gas → liquid. Freezing: liquid → solid. Sublimation: solid → gas directly." },
      { heading: "Brownian Motion", content: "Random motion of small particles (e.g., smoke particles) caused by collisions with invisible air molecules. Evidence for the kinetic theory." },
    ],
  },
  {
    topicId: "p1-3",
    sections: [
      { heading: "Weight vs Mass", content: "Mass: amount of matter (kg), constant everywhere. Weight: gravitational force on an object (N), W = mg. On Earth, g ≈ 10 m/s²." },
      { heading: "Friction", content: "Friction opposes motion. Useful: walking, braking. Harmful: wearing parts, producing heat. Reduced by lubrication or smooth surfaces." },
      { heading: "Pressure", content: "Pressure = Force/Area. Unit: Pascal (Pa) = N/m². Smaller area → greater pressure (e.g., knife edge, high heels)." },
    ],
  },
  {
    topicId: "p1-4",
    sections: [
      { heading: "Forms of Energy", content: "Kinetic, potential (gravitational, elastic), thermal (heat), light, sound, electrical, chemical, nuclear." },
      { heading: "Conservation of Energy", content: "Energy cannot be created or destroyed, only transformed from one form to another. Total energy in a closed system remains constant." },
      { heading: "Efficiency", content: "Efficiency = (useful energy output / total energy input) × 100%. No machine is 100% efficient due to energy losses (usually as heat and sound)." },
    ],
  },
...

  {
    topicId: "p2-1",
    sections: [
      { heading: "Speed, Velocity, Acceleration", content: "Speed = distance/time (scalar). Velocity = displacement/time (vector). Acceleration = change in velocity/time: a = (v - u)/t." },
      { heading: "Equations of Motion (SUVAT)", content: "v = u + at. s = ut + ½at². v² = u² + 2as. s = ½(u + v)t. These apply only for constant (uniform) acceleration." },
      { heading: "Newton's Laws", content: "1st: An object stays at rest or in uniform motion unless acted on by a force. 2nd: F = ma. 3rd: Every action has an equal and opposite reaction." },
      { heading: "Momentum", content: "Momentum p = mv. Conservation of momentum: total momentum before = total momentum after collision." },
    ],
    examples: [
      { problem: "A car accelerates from 10 m/s to 30 m/s in 5 s. Find the acceleration.", solution: "a = (v - u)/t = (30 - 10)/5 = 20/5 = 4 m/s²." },
    ],
  },
  {
    topicId: "p2-2",
    sections: [
      { heading: "Moments", content: "Moment = Force × perpendicular distance from the pivot. Unit: Nm. Clockwise moments vs anticlockwise moments." },
      { heading: "Principle of Moments", content: "For equilibrium: sum of clockwise moments = sum of anticlockwise moments. Also, the resultant force must be zero." },
      { heading: "Centre of Gravity", content: "The point where the entire weight of an object appears to act. For a uniform object, it's at the geometric centre." },
    ],
  },
  {
    topicId: "p2-3",
    sections: [
      { heading: "Pressure in Liquids", content: "P = ρgh. Pressure increases with depth. Pressure acts equally in all directions at a given depth." },
      { heading: "Boyle's Law", content: "At constant temperature: P₁V₁ = P₂V₂. As pressure increases, volume decreases (inversely proportional)." },
      { heading: "Hydraulic Systems", content: "Based on Pascal's principle: pressure applied to an enclosed fluid is transmitted equally. F₁/A₁ = F₂/A₂. Small force on small area → large force on large area." },
    ],
  },
  {
    topicId: "p2-4",
    sections: [
      { heading: "Work Done", content: "Work = Force × distance moved in the direction of the force. W = Fd. Unit: Joule (J)." },
      { heading: "Power", content: "Power = Work/time = Energy/time. Unit: Watt (W). 1 W = 1 J/s." },
      { heading: "Machines", content: "Mechanical Advantage (MA) = Load/Effort. Velocity Ratio (VR) = distance moved by effort / distance moved by load. Efficiency = (MA/VR) × 100%." },
    ],
  },
...

  {
    topicId: "p3-1",
    sections: [
      { heading: "Ohm's Law", content: "V = IR. Voltage (V) = Current (A) × Resistance (Ω). A graph of V vs I for an ohmic conductor is a straight line through the origin." },
      { heading: "Series Circuits", content: "Same current flows through all components. Total resistance: R = R₁ + R₂ + … Total voltage: V = V₁ + V₂ + …" },
      { heading: "Parallel Circuits", content: "Same voltage across each branch. Total current splits: I = I₁ + I₂. 1/R = 1/R₁ + 1/R₂." },
      { heading: "Electrical Power and Energy", content: "P = IV = I²R = V²/R. Energy = Pt = IVt. Domestic electricity is measured in kWh." },
    ],
    examples: [
  ...
  },
  {
    topicId: "p3-2",
    sections: [
      { heading: "Magnets", content: "Like poles repel, unlike poles attract. Magnetic field lines go from North to South outside the magnet. Earth has a magnetic field." },
      { heading: "Electromagnets", content: "A coil of wire carrying current produces a magnetic field. Strength increased by: more turns, more current, iron core." },
      { heading: "Motors and Induction", content: "Motor effect: a current-carrying conductor in a magnetic field experiences a force (Fleming's left-hand rule: F = BIl). Electromagnetic induction: moving a conductor in a magnetic field induces a voltage (Fleming's right-hand rule)." },
      { heading: "Transformers", content: "Vp/Vs = Np/Ns. Step-up: more secondary turns (increases voltage). Step-down: fewer secondary turns. For ideal transformer: VpIp = VsIs." },
    ],
  },
  {
    topicId: "p3-3",
    sections: [
      { heading: "Heat Transfer", content: "Conduction: through solids (metals are best). Convection: through fluids (hot fluid rises). Radiation: through vacuum (infrared waves)." },
      { heading: "Specific Heat Capacity", content: "Q = mcΔθ. The energy needed to raise 1 kg of a substance by 1°C. Water has a high SHC (4200 J/kg°C)." },
      { heading: "Latent Heat", content: "Q = ml. Latent heat of fusion: energy to change solid → liquid (no temperature change). Latent heat of vaporisation: liquid → gas." },
    ],
    examples: [
      { problem: "How much energy to heat 2 kg of water from 20°C to 100°C? (c = 4200 J/kg°C)", solution: "Q = mcΔθ = 2 × 4200 × 80 = 672,000 J = 672 kJ." },
    ],
  },
  {
    topicId: "p3-4",
    sections: [
      { heading: "Reflection", content: "Angle of incidence = angle of reflection. Both measured from the normal. Image in a plane mirror: same size, laterally inverted, virtual." },
      { heading: "Refraction", content: "Light bends when passing between media of different densities. Snell's law: n₁ sin i = n₂ sin r, or n = sin i / sin r." },
      { heading: "Total Internal Reflection", content: "Occurs when light goes from denser to less dense medium and angle exceeds the critical angle. sin c = 1/n. Used in optical fibres and prisms." },
      { heading: "Lenses", content: "Converging (convex) lens: brings parallel rays to a focus. Diverging (concave) lens: spreads rays out. Lens formula: 1/f = 1/u + 1/v. Magnification = v/u." },
    ],
  },
...

  {
    topicId: "p4-1",
    sections: [
      { heading: "Wave Properties", content: "Amplitude: maximum displacement. Wavelength (λ): distance between two consecutive crests. Frequency (f): number of complete waves per second. Period T = 1/f. Wave speed: v = fλ." },
      { heading: "Types of Waves", content: "Transverse: vibration perpendicular to direction of travel (e.g., light, water). Longitudinal: vibration parallel to direction (e.g., sound)." },
      { heading: "Sound Waves", content: "Need a medium to travel. Speed in air ≈ 340 m/s. Echo: reflection of sound. Frequency determines pitch; amplitude determines loudness." },
    ],
  },
  {
    topicId: "p4-2",
    sections: [
      { heading: "The Spectrum", content: "In order of increasing frequency: Radio → Microwave → Infrared → Visible → Ultraviolet → X-ray → Gamma. All travel at c = 3 × 10⁸ m/s in a vacuum." },
      { heading: "Uses", content: "Radio: communication. Microwave: cooking, satellite. IR: heating, remote controls. Visible: sight. UV: fluorescent lights, sterilisation. X-ray: medical imaging. Gamma: cancer treatment, sterilisation." },
    ],
  },
  {
    topicId: "p4-3",
    sections: [
      { heading: "Atomic Structure", content: "Atom: protons and neutrons in nucleus, electrons orbiting. Atomic number = protons. Mass number = protons + neutrons." },
      { heading: "Radioactive Decay", content: "Alpha (α): 2p + 2n, stopped by paper, strong ioniser. Beta (β): fast electron, stopped by aluminium. Gamma (γ): electromagnetic wave, stopped by thick lead." },
      { heading: "Half-Life", content: "Time for half the radioactive atoms to decay. A = A₀ × (½)^(t/t½). After n half-lives, fraction remaining = (½)ⁿ." },
      { heading: "Nuclear Energy", content: "Fission: heavy nucleus splits into lighter nuclei (nuclear power). Fusion: light nuclei combine (stars). E = mc²." },
    ],
  },
  {
    topicId: "p4-4",
    sections: [
      { heading: "Diodes and LEDs", content: "A diode allows current in one direction only. An LED emits light when forward-biased." },
      { heading: "Logic Gates", content: "AND: output 1 only if both inputs are 1. OR: output 1 if at least one input is 1. NOT: inverts the input. NAND = NOT + AND. NOR = NOT + OR." },
      { heading: "Transistor as Switch", content: "A small base current switches on a larger collector current. Used in amplifiers and switching circuits." },
    ],
  },
